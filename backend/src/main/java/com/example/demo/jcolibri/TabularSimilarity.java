...
public class TabularSimilarity implements LocalSimilarityFunction {
	...
	public double compute(Object value1, Object value2) throws NoApplicableSimilarityFunctionException {
		...
		if ((value1 instanceof Boolean && value2 instanceof Boolean) || (value1 instanceof FinancialStatus && value2 instanceof FinancialStatus) || (value1 instanceof CrimeType && value2 instanceof CrimeType))
			return compute(String.valueOf(value1), String.valueOf(value2));
